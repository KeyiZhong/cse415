...
This file contains my uniform cost search algorithm implementation.
'''
...
#         and if it is already on CLOSED, delete the new instance.
   ...
   # EACH SUCCESSOR.***
    ...
    for op in Problem.OPERATORS:
      if op.precond(S):
        ...
        print(new_state)
        if not (new_state in CLOSED) and OPEN.__contains__(new_state) == False:
  ...
  print_state_queue('open', OPEN)
  #print_state_queue('close',CLOSED)
